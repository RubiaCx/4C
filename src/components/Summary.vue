      ...
      <el-col :xs="24" :sm="24" :lg="12">
        <div class="grid-content">
          <div class="grid-content-R1">
            ...
            <div class="border_corner border_corner_right_top"></div>
            <div class="border_corner border_corner_left_bottom"></div>
            <div class="border_corneLr border_corner_right_bottom"></div>
            <!-- 标题 -->
...
<script>
const chart1 = () => import("./charts/Sum4");
const chart2 = () => import("./charts/Sum2");
const chart3 = () => import("./charts/Sum3");
const chart4 = () => import("./charts/Bugs3");
export default {
  data() {
    return {};
  },
